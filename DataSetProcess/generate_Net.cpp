...
int main(int argc, char* argv[]) {
  ...
  const int NEdges = Env.GetIfArgPrefixInt("-e:", 2048, "Number of edges (default:1024)\n");
  ...
  const TStr NetworkParams = Env.GetIfArgPrefixStr("-g:", TStr("5; 0.12; 0.1; 1; 0; 0"), "Parameters for the network (default:0.9 0.5; 0.5 0.3)\n"); // network params for kronecker/forest-fire
  ...
  const TStr VaryingType = Env.GetIfArgPrefixStr("-vt:", "0;0;0;0;0;0;1;0", "Varying trends percentages for tx rates\nconstant;linear;exponential;rayleigh;slab;square;chainsaw;random (default:1;0;0;0;0;0)");
